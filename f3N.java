...
import java.io.*;
class showhintf3N extends Thread
{
JLabel frm6;
public showhintf3N(JLabel obj)
{
frm6=obj;
}
...
for(int i=0;i<10;i++)
{
frm6.setVisible(!frm6.isVisible());
Thread.sleep(200);
}
...
//----------------------------------------------
class showtimef3N implements Runnable
{
f3N frm6;
JLabel lb8;
int time;
int o;
public showtimef3N(f3N obj,JLabel object,int tm)
{
frm6=obj;
time=tm;
lb8=object;
...
{for(int j=60;j>=0;j--)
{lb8.setText(""+i+":"+j+"");
 lb8.setFont(new Font("Algerian", Font.BOLD,30));
...
//-------------------------------------------------------------------
class f3N extends JFrame implements MouseListener
{
...
c3.setText(""+(i*100)+"Points");
 c3.setFont(new Font("algerian", Font.ITALIC,19));
	...
	pack();
        showtimef3N t=new showtimef3N(this,c2,2);
	 th=new Thread(t);
	th.start();
r="label";
 s="label1";
...
public static void checkscore(f3N bgf3N)
{int i;
bgf3N.c3.setText(""+(bgf3N.i*100)+"Points");
 bgf3N.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf3N.c3.setForeground(Color.black);

i=bgf3N.i*100;
bgf3N.k=i;
}

public static void check(f3N bgf3N)
...
if(bgf3N.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf3N.c3.setText(""+(j+bgf3N.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf3N.h1.setVisible(false);}


if(bgf3N.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf3N.h2.setVisible(false);}


if(bgf3N.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf3N.h3.setVisible(false);}
bgf3N.k=bgf3N.k+a;
JOptionPane.showMessageDialog(null,"Total Score:"+bgf3N.k);
String r1=null;  
FileInputStream fin;
...
{FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf3N.k);
		    fout.close();		
		}
		catch (IOException e)
		{
