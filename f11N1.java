...
import java.io.*;
class showhintf11N1 extends Thread
{
JLabel frm31;
public showhintf11N1(JLabel obj)
{
frm31=obj;
}
public void run()
...
for(int i=0;i<10;i++)
{
frm31.setVisible(!frm31.isVisible());
Thread.sleep(200);
}
frm31.setVisible(true);
}
catch(Exception ex)
{
...
//-----------------------------------------------
class showtimef11N1 implements Runnable
{
f11N1 frm31;
int time;
JLabel lb28;
public showtimef11N1(f11N1 obj,JLabel object,int tm)
{
frm31=obj;
time=tm;
lb28=object;
...
class f11N1 extends JFrame implements MouseListener
{
...
panel.add(l15);
 ...
 c1.setBounds(1180, 640, size.width+120, size.height+80);
          c2.setBounds(50, 50, size.width+80, size.height+20);
          c3.setBounds(1245, 57, size.width+100, size.height+20);
	 ...
	 h2.setBounds(30, 610, 100,100);	
          ...
          label.setBounds(640, 600, size.width+80, size.height+80);
	  label1.setBounds(499, 250, size.width+80, size.height+80);	
	  ...
	  label7.setBounds(120, 540, size.width+80, size.height+80);
	  label8.setBounds(1230, 545, size.width+80, size.height+80);
	  label9.setBounds(990, 295, size.width+80, size.height+80);          
	  ...
	  label13.setBounds(1230, 155, size.width+80, size.height+80);
...
showtimef11N1 t=new showtimef11N1(this,c2,2);
	th=new Thread(t);
	th.start();
}
...
public static void checkscore(f11N1 bgf11N1)
{int i,k17;
k17=bgf11N1.k17;
bgf11N1.c3.setText(""+(k17+(bgf11N1.i*100))+"Points");
 bgf11N1.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf11N1.c3.setForeground(Color.black);
bgf11N1.k18=k17+(bgf11N1.i*100);

}
public static void check(f11N1 bgf11N1)
{
...
if(bgf11N1.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf11N1.c3.setText(""+(j+bgf11N1.k18+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf11N1.h1.setVisible(false);}


if(bgf11N1.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf11N1.h2.setVisible(false);}


if(bgf11N1.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf11N1.h3.setVisible(false);}
bgf11N1.k18=bgf11N1.k18+a;
JOptionPane.showMessageDialog(null,"Total Score:"+bgf11N1.k18);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf11N1.k18);
		    fout.close();		
		}
		catch (IOException e)
		{
