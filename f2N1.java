...
import java.io.*;
class showtimef2n1 implements Runnable
{
f2N1 frm4;
int time;
JLabel lb6;
public showtimef2n1(f2N1 obj,JLabel object,int tm)
{
frm4=obj;
time=tm;
lb6=object;
...
{for(int j=60;j>=0;j--)
{lb6.setText(""+i+":"+j+"");
 lb6.setFont(new Font("Algerian", Font.BOLD,30));
...
//----------------------------------------------
class showhintf2n1 extends Thread
{
JLabel frm4;
public showhintf2n1(JLabel obj)
{
frm4=obj;
}
...
for(int i=0;i<10;i++)
{
frm4.setVisible(!frm4.isVisible());
Thread.sleep(200);
}
...
class f2N1 extends JFrame implements MouseListener
{
    JLabel label,label1,label2,label3,label4,label5,label6,label7,label8,label9,label10,label11,label12,label13,label14,l,u,v,w,a,b,c,h1,h2,h3,b1,b2,b3,c1,c2,c3;
    int i,k;
    boolean dt;
String r,s,q;
showhintf2n1 sh4;
...
panel.add(c3);
 ...
 b1.setBounds(400, 600, size.width+50, size.height+50);
	  ...
	  label1.setBounds(708, 0, size.width+80, size.height+80);	
	  ...
	  label11.setBounds(260, 450, size.width+100, size.height+100);
...
c3.setText(""+(i*100)+"Points");
 c3.setFont(new Font("algerian", Font.ITALIC,13));
	...
	pack();
 showtimef2n1 t=new showtimef2n1(this,c2,2);
	th=new Thread(t);
	th.start();
r="label";
 s="label1";
...
public static void checkscore(f2N1 bgf2N1)
{int i;
bgf2N1.c3.setText(""+(bgf2N1.i*100)+"Points");
 bgf2N1.c3.setFont(new Font("algerian", Font.ITALIC,13));
      bgf2N1.c3.setForeground(Color.black);

i=bgf2N1.i*100;
bgf2N1.k=i;

}
public static void check(f2N1 bgf2n1)
{
int i,j,a;
if(bgf2n1.i==15)
...
if(bgf2n1.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf2n1.c3.setText(""+(j+bgf2n1.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf2n1.h1.setVisible(false);}


if(bgf2n1.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf2n1.h2.setVisible(false);}


if(bgf2n1.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf2n1.h3.setVisible(false);}
bgf2n1.k=bgf2n1.k+a;
JOptionPane.showMessageDialog(null,"Total Score:"+bgf2n1.k);
String r1=null;  
FileInputStream fin;
...
{FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf2n1.k);
		    fout.close();		
		}
		catch (IOException e)
		{
