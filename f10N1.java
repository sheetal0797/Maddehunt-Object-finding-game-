...
import java.io.*;
class showhintf10N1 extends Thread
{
JLabel frm28;
public showhintf10N1(JLabel obj)
{
frm28=obj;
}
public void run()
...
for(int i=0;i<10;i++)
{
frm28.setVisible(!frm28.isVisible());
Thread.sleep(200);
}
frm28.setVisible(true);
}
catch(Exception ex)
{
...
//-----------------------------------------------
class showtimef10N1 implements Runnable
{
f10N1 frm28;
int time;
JLabel lb30;
public showtimef10N1(f10N1 obj,JLabel object,int tm)
{
frm28=obj;
time=tm;
lb30=object;
...
{for(int j=60;j>=0;j--)
{lb30.setText(""+i+":"+j+"");
 lb30.setFont(new Font("Algerian", Font.BOLD,30));
...
class f10N1 extends JFrame implements MouseListener
{
...
panel.add(l15);
 ...
 c1.setBounds(1180, 665, size.width+60, size.height+20);
          ...
          c3.setBounds(1248, 70, size.width+100, size.height+20);
  h1.setBounds(10, 610, 100,100);
	 h2.setBounds(30, 610, 100,100);	
          h3.setBounds(50, 610, 100,100);

          label.setBounds(1090, 230, size.width+80, size.height+80);
	  ...
	  label4.setBounds(620, 310, size.width+80, size.height+80);
	  label5.setBounds(605, 22, size.width+80, size.height+80);	
          label6.setBounds(360, 500, size.width+80, size.height+80);
	  label7.setBounds(450, 340, size.width+80, size.height+80);
	  label8.setBounds(900, 380, size.width+80, size.height+80);
	  label9.setBounds(190, 580, size.width+80, size.height+80);    
          label10.setBounds(1260, 520, size.width+80, size.height+80);
	  label11.setBounds(1115, 594, size.width+80, size.height+80);
	  label12.setBounds(955, 245, size.width+80, size.height+80);
	  label13.setBounds(1225, 600, size.width+80, size.height+80);
	  label14.setBounds(500, 540, size.width+80, size.height+80);

          l1.setBounds(50, 5, size.width+1250, size.height+20);
          l2.setBounds(50, 5, size.width+1250, size.height+20);
          l3.setBounds(50, 5, size.width+1250, size.height+20);
          l4.setBounds(50, 5, size.width+1250, size.height+20);
          l5.setBounds(50, 5, size.width+1250, size.height+20);
          l6.setBounds(50, 5, size.width+1250, size.height+20);
          l7.setBounds(50, 5, size.width+1250, size.height+20);
          l8.setBounds(50, 5, size.width+1250, size.height+20);
          l9.setBounds(50, 5, size.width+1250, size.height+20);
          l10.setBounds(50, 5, size.width+1250, size.height+20);
          l11.setBounds(50, 5, size.width+1250, size.height+20);     
          l12.setBounds(50, 5, size.width+1250, size.height+20);
          l13.setBounds(50, 5, size.width+1250, size.height+20);
          l14.setBounds(50, 5, size.width+1250, size.height+20);
          l15.setBounds(50, 5, size.width+1250, size.height+20);
l2.setVisible(false);
l3.setVisible(false);
l4.setVisible(false);
l5.setVisible(false);
...
showtimef10N1 t=new showtimef10N1(this,c2,2);
th=new Thread(t);
	th.start();
}
...
l14.setVisible(true);
label12.setVisible(false);check(this);hintsong d2=new hintsong();
	Thread e2=new Thread(d2);
	e2.start();}
...
public static void checkscore(f10N1 bgf10N1)
{int i;
bgf10N1.c3.setText(""+(bgf10N1.i*100)+"Points");
 bgf10N1.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf10N1.c3.setForeground(Color.black);

i=bgf10N1.i*100;
bgf10N1.k=i;
}
public static void check(f10N1 bgf10N1)
{
int i,j,a;
if(bgf10N1.i==15)
{
...
if(bgf10N1.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf10N1.c3.setText(""+(j+bgf10N1.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf10N1.h1.setVisible(false);}


if(bgf10N1.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf10N1.h2.setVisible(false);}


if(bgf10N1.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf10N1.h3.setVisible(false);}
bgf10N1.k=bgf10N1.k+a;
JOptionPane.showMessageDialog(null,"Total Score:"+bgf10N1.k);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf10N1.k);
		    fout.close();		
		}
		catch (IOException e)
		{
