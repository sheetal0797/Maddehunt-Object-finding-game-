...
import java.io.*;
class showhintf1N1 extends Thread
{
JLabel frm45;
public showhintf1N1(JLabel obj)
{
frm45=obj;
}
...
for(int i=0;i<10;i++)
{
frm45.setVisible(!frm45.isVisible());
Thread.sleep(200);
}
frm45.setVisible(true);
}
catch(Exception ex)
{
...
//----------------------------------------------
class showtimef1N1 implements Runnable
{
f1N1 frm45;
JLabel lb3;
int time;
public showtimef1N1(f1N1 obj,JLabel object,int tm)
{
frm45=obj;
time=tm;
lb3=object;
...
{for(int j=60;j>=0;j--)
{lb3.setText(""+i+":"+j+"");
 lb3.setFont(new Font("Algerian", Font.BOLD,30));
...
//-------------------------------------------------------------------
class f1N1 extends JFrame implements MouseListener
{
...
c1.setIcon(new ImageIcon("obj/c6.png"));
  ...
  a.setIcon(new ImageIcon("obj/beetle1.png"));
	...
	b3.setIcon(new ImageIcon("b3.png"));
        ...
        label1.setIcon(new ImageIcon("obj/whistle6.png"));
	...
	label6.setIcon(new ImageIcon("obj/rollingpin5.png"));
	...
	label13.setIcon(new ImageIcon("obj/clarinet3.png"));
...
h1.setBounds(10, 620, 100,100);
	 h2.setBounds(30, 620, 100,100);	
          ...
          b1.setBounds(400, 600, size.width+60, size.height+60);
	  b2.setBounds(500, 600, size.width+60, size.height+60);	
          b3.setBounds(600, 600, size.width+60, size.height+60);
	  ...
	  b.setBounds(480, 640, size.width+60, size.height+60);	
          c.setBounds(580, 640, size.width+60, size.height+60);
               label.setBounds(250, 410, size.width, size.height);
	  label1.setBounds(297, 80, size.width+50, size.height+50);	
          label2.setBounds(30,380, size.width+100, size.height+100);
	  label3.setBounds(345, 430, size.width+50, size.height+100);
	  label4.setBounds(540, 410, size.width+80, size.height+80);
	  label5.setBounds(590, 60, size.width+50, size.height+50);	
          label6.setBounds(158, 275, size.width+100, size.height+100);
	  label7.setBounds(350, 528, size.width+80, size.height+80);
	  label8.setBounds(850, 240, size.width+100, size.height+100);
	  label9.setBounds(993, 360, size.width+50, size.height+50);          
          label10.setBounds(1120, 390, size.width+20, size.height+20);
	  label11.setBounds(920, 295, size.width+50, size.height+50);
	  label12.setBounds(0, 500, size.width+100, size.height+100);
	  label13.setBounds(860, 510, size.width+60, size.height+60);
	  label14.setBounds(350, 360, size.width+100, size.height+100);
...
c3.setText(""+(i*100)+"Points");
 c3.setFont(new Font("algerian", Font.ITALIC,19));
	...
	pack();
        showtimef1N1 t=new showtimef1N1(this,c2,2);
	th=new Thread(t);
	th.start();
r="label";
 s="label1";
...
public static void checkscore(f1N1 bgf1N1)
{int i;
bgf1N1.c3.setText(""+(bgf1N1.i*100)+"Points");
 bgf1N1.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf1N1.c3.setForeground(Color.black);

i=bgf1N1.i*100;
bgf1N1.k=i;
}

public static void check(f1N1 bgf1N1)
{int i,a,j;
if(bgf1N1.i==15)
{//JOptionPane.showMessageDialog(null,"Congratulations!!! You Have Cleared Stage Successfully. f1N1 Moving To Next Stage");
a=0;

if(bgf1N1.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf1N1.c3.setText(""+(j+bgf1N1.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf1N1.h1.setVisible(false);}


if(bgf1N1.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf1N1.h2.setVisible(false);}


if(bgf1N1.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf1N1.h3.setVisible(false);}
bgf1N1.k=bgf1N1.k+a;

JOptionPane.showMessageDialog(null,"Total Score:"+bgf1N1.k);
String r1=null;  
FileInputStream fin;
...
{FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf1N1.k);
		    fout.close();		
		}
		catch (IOException e)
		{
