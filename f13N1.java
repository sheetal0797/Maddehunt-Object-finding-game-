...
import java.io.*;
class showhintf13N1 extends Thread
{
JLabel frm37;
public showhintf13N1(JLabel obj)
{
frm37=obj;
}
...
for(int i=0;i<10;i++)
{
frm37.setVisible(!frm37.isVisible());
Thread.sleep(200);
}
frm37.setVisible(true);
}
catch(Exception ex)
{
...
//-----------------------------------------------
class showtimef13N1 implements Runnable
{
f13N1 frm37;
int time;
JLabel lb39;
public showtimef13N1(f13N1 obj,JLabel object,int tm)
{
frm37=obj;
time=tm;
lb39=object;
...
{for(int j=60;j>=0;j--)
{lb39.setText(""+i+":"+j+"");
 lb39.setFont(new Font("Algerian", Font.BOLD,30));
...
class f13N1 extends JFrame implements MouseListener
{
...
panel.add(c3);
  ...
  h1.setBounds(10, 620, 100,100);
	 h2.setBounds(30, 620, 100,100);	
          ...
          label.setBounds(183, 290, size.width+80, size.height+80);
	  label1.setBounds(430, 360, size.width+80, size.height+80);	
	  ...
	  label5.setBounds(250, 100, size.width+80, size.height+80);	
          label6.setBounds(1100, 240, size.width+80, size.height+80);
	  label7.setBounds(690, 220, size.width+80, size.height+80);
	  label8.setBounds(100, 400, size.width+80, size.height+80);
	  label9.setBounds(300, 250, size.width+80, size.height+80);          
          label10.setBounds(1050, 0, size.width+80, size.height+80);
	  label11.setBounds(740, 395, size.width+80, size.height+80);
	  label12.setBounds(900, 490, size.width+80, size.height+80);
	  label13.setBounds(850, 170, size.width+80, size.height+80);
...
showtimef13N1 t=new showtimef13N1(this,c2,2);
	 th=new Thread(t);
	th.start();
}
...
public static void checkscore(f13N1 bgf13N1)
{int i;
bgf13N1.c3.setText(""+(bgf13N1.i*100)+"Points");
 bgf13N1.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf13N1.c3.setForeground(Color.black);

i=bgf13N1.i*100;
bgf13N1.k=i;
}
public static void check(f13N1 bgf13N1)
{
int i,j,a;
if(bgf13N1.i==15)
{
...
if(bgf13N1.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf13N1.c3.setText(""+(j+bgf13N1.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf13N1.h1.setVisible(false);}


if(bgf13N1.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf13N1.h2.setVisible(false);}


if(bgf13N1.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf13N1.h3.setVisible(false);}
bgf13N1.k=bgf13N1.k+a;

JOptionPane.showMessageDialog(null,"Total Score:"+bgf13N1.k);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf13N1.k);
		    fout.close();		
		}
		catch (IOException e)
		{
