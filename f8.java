...
class showhintf8 extends Thread
{
JLabel frm20;
public showhintf8(JLabel obj)
{
frm20=obj;
}
...
for(int i=0;i<10;i++)
{
frm20.setVisible(!frm20.isVisible());
Thread.sleep(200);
}
...
//-----------------------------------------------
class showtimef8 implements Runnable
{
f8 frm20;
int time;
JLabel lb22;
public showtimef8(f8 obj,JLabel object,int tm)
{
frm20=obj;
time=tm;
lb22=object;
...
{for(int j=60;j>=0;j--)
{lb22.setText(""+i+":"+j+"");
 lb22.setFont(new Font("Algerian", Font.BOLD,30));
...
class f8 extends JFrame implements MouseListener
{
...
c1.setIcon(new ImageIcon("obj/c6.png"));
 h1.setIcon(new ImageIcon("h1.png"));
	...
	label14 = new JLabel();
        ...
        label.setIcon(new ImageIcon("obj/egg.png"));
	...
	label3.setIcon(new ImageIcon("obj/PSR.png"));
        label4.setIcon(new ImageIcon("obj/rat1.png"));
	...
	label11.setIcon(new ImageIcon("obj/speakers1.png"));
...
panel.add(h1); h1.addMouseListener(this);
   ...
   c1.setBounds(1200, 660, size.width+120, size.height+80);
          c2.setBounds(250, 0, size.width+80, size.height+20);
          c3.setBounds(835, 7, size.width+80, size.height+20);
  h1.setBounds(10, 600, 100,100);
	 h2.setBounds(30, 600, 100,100);	
          h3.setBounds(50, 600, 100,100);

          label.setBounds(1126, 276, size.width+80, size.height+80);
	  label1.setBounds(654, 478, size.width+80, size.height+80);	
          label2.setBounds(410, 600, size.width+80, size.height+80);
	  label3.setBounds(360, 425, size.width+80, size.height+80);
	  label4.setBounds(740, 316, size.width+80, size.height+80);
	  label5.setBounds(49, 316, size.width+80, size.height+80);	
          label6.setBounds(0, 480, size.width+80, size.height+80);
	  label7.setBounds(1120, 60, size.width+80, size.height+80);
	  label8.setBounds(0, 370, size.width+80, size.height+80);
	  label9.setBounds(727, 558, size.width+80, size.height+80);          
          label10.setBounds(370, 300, size.width+80, size.height+80);
	  label11.setBounds(1100, 190, size.width+80, size.height+80);
	  label12.setBounds(350, 605, size.width+80, size.height+80);
	  label13.setBounds(535, 30, size.width+80, size.height+80);
	  label14.setBounds(1270, 390, size.width+80, size.height+80);
...
c3.setText(""+(i*100)+"Points");
 c3.setFont(new Font("algerian", Font.ITALIC,20));
      c3.setForeground(Color.black);
	pack();
showtimef8 t=new showtimef8(this,c2,2);
	 th=new Thread(t);
	th.start();
...
public static void checkscore(f8 bgf8)
{int i,k13;
k13=bgf8.k13;
bgf8.c3.setText(""+(k13+(bgf8.i*100))+"Points");
 bgf8.c3.setFont(new Font("algerian", Font.ITALIC,20));
      bgf8.c3.setForeground(Color.black);
bgf8.k14=k13+(bgf8.i*100);
}
public static void check(f8 bgf8)
{
int i,j,a;
if(bgf8.i==15)
{
...
if(bgf8.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf8.c3.setText(""+(j+bgf8.k14+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf8.h1.setVisible(false);}


if(bgf8.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf8.h2.setVisible(false);}


if(bgf8.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf8.h3.setVisible(false);}
bgf8.k14=bgf8.k14+a;
JOptionPane.showMessageDialog(null,"Total Score:"+bgf8.k14);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf8.k14);
		    fout.close();		
		}
		catch (IOException e)
		{
