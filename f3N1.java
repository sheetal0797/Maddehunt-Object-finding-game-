...
import java.io.*;
class showhintf3N1 extends Thread
{
JLabel frm7;
public showhintf3N1(JLabel obj)
{
frm7=obj;
}
...
for(int i=0;i<10;i++)
{
frm7.setVisible(!frm7.isVisible());
Thread.sleep(200);
}
...
//----------------------------------------------
class showtimef3N1 implements Runnable
{
f3N1 frm7;
JLabel lb9;
int time;
int o;
public showtimef3N1(f3N1 obj,JLabel object,int tm)
{
frm7=obj;
time=tm;
lb9=object;
...
{for(int j=60;j>=0;j--)
{lb9.setText(""+i+":"+j+"");
 lb9.setFont(new Font("Algerian", Font.BOLD,30));
...
//-------------------------------------------------------------------
class f3N1 extends JFrame implements MouseListener
{
...
c3.setText(""+(i*100)+"Points");
 c3.setFont(new Font("algerian", Font.ITALIC,19));
	...
	pack();
        showtimef3N1 t=new showtimef3N1(this,c2,2);
	th=new Thread(t);
	th.start();
r="label";
 s="label1";
...
public static void checkscore(f3N1 bgf3N1)
{int i;
bgf3N1.c3.setText(""+(bgf3N1.i*100)+"Points");
 bgf3N1.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf3N1.c3.setForeground(Color.black);

i=bgf3N1.i*100;
bgf3N1.k=i;
}

public static void check(f3N1 bgf3N1)
{int i,j,a;
if(bgf3N1.i==15)
{//JOptionPane.showMessageDialog(null,"Congratulations!!! You Have Cleared Stage Successfully. f2 Moving To Next Stage");
a=0;

if(bgf3N1.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf3N1.c3.setText(""+(j+bgf3N1.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf3N1.h1.setVisible(false);}


if(bgf3N1.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf3N1.h2.setVisible(false);}


if(bgf3N1.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf3N1.h3.setVisible(false);}
bgf3N1.k=bgf3N1.k+a;

JOptionPane.showMessageDialog(null,"Total Score:"+bgf3N1.k);
String r1=null;  
FileInputStream fin;
...
{FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf3N1.k);
		    fout.close();		
		}
		catch (IOException e)
		{
