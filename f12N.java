...
import java.io.*;
class showhintf12N extends Thread
{
JLabel frm33;
public showhintf12N(JLabel obj)
{
frm33=obj;
}
public void run()
...
for(int i=0;i<10;i++)
{
frm33.setVisible(!frm33.isVisible());
Thread.sleep(200);
}
frm33.setVisible(true);
}
catch(Exception ex)
{
...
//-----------------------------------------------
class showtimef12N implements Runnable
{
f12N frm33;
int time;
JLabel lb35;
public showtimef12N(f12N obj,JLabel object,int tm)
{
frm33=obj;
time=tm;
lb35=object;
...
{for(int j=60;j>=0;j--)
{lb35.setText(""+i+":"+j+"");
 lb35.setFont(new Font("Algerian", Font.BOLD,30));
...
class f12N extends JFrame implements MouseListener
{
...
l1 = new JLabel("An instrument containing a magnetized pointer which shows the direction of magnetic north and bearings from it.");  
  l1.setFont(new Font("times new roman", Font.BOLD,20));
      l1.setForeground(Color.blue);       
l2 = new JLabel("A weapon with a long metal blade and a hilt with a hand guard, used for thrusting or striking and now typically worn as part of ceremonial dress");
  ...
  l8.setFont(new Font("times new roman", Font.BOLD,20));
      l8.setForeground(Color.blue); 
        l9 = new JLabel("A surgical instrument that resembles a pair of tongs and can be used in surgery for grabbing, maneuvering, or removing various things within or from the body."); 
  ...
  l11.setFont(new Font("times new roman", Font.BOLD,20));
	...
	l12 = new JLabel("A symbol of legal right created by the law of a country, that grants the creator of an original work exclusive rights to its use and distribution,"); 
  ...
  l14.setFont(new Font("times new roman", Font.BOLD,20));
	...
	l15 = new JLabel("A small cube with each side having a different number of spots on it, ranging from one to six, thrown and used in gambling and other games involving chance");
...
showtimef12N t=new showtimef12N(this,c2,2);
	th=new Thread(t);
	th.start();
}
...
public static void checkscore(f12N bgf12N)
{int i;
bgf12N.c3.setText(""+(bgf12N.i*100)+"Points");
 bgf12N.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf12N.c3.setForeground(Color.black);

i=bgf12N.i*100;
bgf12N.k=i;
}
public static void check(f12N bgf12N)
{
int i,j,a;
if(bgf12N.i==15)
{
...
if(bgf12N.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf12N.c3.setText(""+(j+bgf12N.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf12N.h1.setVisible(false);}


if(bgf12N.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf12N.h2.setVisible(false);}


if(bgf12N.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf12N.h3.setVisible(false);}
bgf12N.k=bgf12N.k+a;
JOptionPane.showMessageDialog(null,"Total Score:"+bgf12N.k);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf12N.k);
		    fout.close();		
		}
		catch (IOException e)
		{
