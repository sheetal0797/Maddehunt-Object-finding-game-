...
import java.io.*;
class showhintf6N1 extends Thread
{
JLabel frm16;
public showhintf6N1(JLabel obj)
{
frm16=obj;
}
...
for(int i=0;i<10;i++)
{
frm16.setVisible(!frm16.isVisible());
Thread.sleep(200);
}
...
//---------------------------------------
class showtimef6N1 implements Runnable
{
f6N1 frm16;
int time;
JLabel lb18;
public showtimef6N1(f6N1 obj,JLabel object,int tm)
{
frm16=obj;
time=tm;
lb18=object;
...
{for(int j=60;j>=0;j--)
{lb18.setText(""+i+":"+j+"");
 lb18.setFont(new Font("Algerian", Font.BOLD,30));
...
class f6N1 extends JFrame implements MouseListener
{
...
panel.add(h1); h1.addMouseListener(this);
  ...
  h1.setBounds(10, 610, 100,100);
	 h2.setBounds(30, 610, 100,100);	
          ...
          label.setBounds(1160, 310, size.width+80, size.height+80);
	  label1.setBounds(820, 330, size.width+80, size.height+80);	
          label2.setBounds(374, 443, size.width+80, size.height+80);
	  label3.setBounds(190, 430, size.width+80, size.height+80);
	  label4.setBounds(498, 564, size.width+80, size.height+80);
	  label5.setBounds(170, 162, size.width+80, size.height+80);	
          label6.setBounds(304, 502, size.width+80, size.height+80);
	  label7.setBounds(1171, 508, size.width+80, size.height+80);
	  label8.setBounds(299, 565, size.width+80, size.height+80);
	  label9.setBounds(875, 585, size.width+80, size.height+80);          
          label10.setBounds(745, 520, size.width+80, size.height+80);
	  label11.setBounds(584, 440, size.width+80, size.height+80);
	  label12.setBounds(144, 508, size.width+80, size.height+80);
	  label13.setBounds(490, 350, size.width+80, size.height+80);
...
c3.setText(""+(i*100)+"Points");
 c3.setFont(new Font("algerian", Font.ITALIC,19));
	...
	pack();
showtimef6N1 t=new showtimef6N1(this,c2,2);
	th=new Thread(t);
	th.start();
...
public static void checkscore(f6N1 bgf6N1)
{int i;
bgf6N1.c3.setText(""+(bgf6N1.i*100)+"Points");
 bgf6N1.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf6N1.c3.setForeground(Color.black);

i=bgf6N1.i*100;
bgf6N1.k=i;
}
public static void check(f6N1 bgf6N1)
{
int i,j,a;
if(bgf6N1.i==15)
{
...
if(bgf6N1.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf6N1.c3.setText(""+(j+bgf6N1.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf6N1.h1.setVisible(false);}


if(bgf6N1.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf6N1.h2.setVisible(false);}


if(bgf6N1.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf6N1.h3.setVisible(false);}
bgf6N1.k=bgf6N1.k+a;

JOptionPane.showMessageDialog(null,"Total Score:"+bgf6N1.k);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf6N1.k);
		    fout.close();		
		}
		catch (IOException e)
		{
