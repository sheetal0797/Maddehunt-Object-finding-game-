...
import java.io.*;
class showhintf6N extends Thread
{
JLabel frm15;
public showhintf6N(JLabel obj)
{
frm15=obj;
}
...
for(int i=0;i<10;i++)
{
frm15.setVisible(!frm15.isVisible());
Thread.sleep(200);
}
...
//---------------------------------------
class showtimef6N implements Runnable
{
f6N frm15;
int time;
JLabel lb17;
public showtimef6N(f6N obj,JLabel object,int tm)
{
frm15=obj;
time=tm;
lb17=object;
...
{for(int j=60;j>=0;j--)
{lb17.setText(""+i+":"+j+"");
 lb17.setFont(new Font("Algerian", Font.BOLD,30));
...
class f6N extends JFrame implements MouseListener
{
  ...
  h1.setBounds(10, 610, 100,100);
	 h2.setBounds(30, 610, 100,100);	
          h3.setBounds(50, 610, 100,100);
           label.setBounds(1167, 110, size.width+80, size.height+80);
	  label1.setBounds(480, 338, size.width+80, size.height+80);	
          label2.setBounds(798, 498, size.width+80, size.height+80);
	  label3.setBounds(305, 470, size.width+80, size.height+80);
	  label4.setBounds(500, 571, size.width+80, size.height+80);
	  label5.setBounds(72, 170, size.width+80, size.height+80);	
          label6.setBounds(1018, 560, size.width+80, size.height+80);
	  label7.setBounds(304, 570, size.width+80, size.height+80);
	  label8.setBounds(1240, 518, size.width+80, size.height+80);
	  label9.setBounds(144, 508, size.width+80, size.height+80);          
          label10.setBounds(820, 380, size.width+80, size.height+80);
	  label11.setBounds(584, 227, size.width+80, size.height+80);
	  label12.setBounds(105, 40, size.width+80, size.height+80);
	  label13.setBounds(509, 483, size.width+80, size.height+80);
	  label14.setBounds(1000, 40, size.width+80, size.height+80);l1.setBounds(180, 688, size.width+40, size.height);
          ...
          l10.setBounds(340, 663, size.width+40, size.height);
...
c3.setText(""+(i*100)+"Points");
 c3.setFont(new Font("algerian", Font.ITALIC,19));
	...
	pack();
showtimef6N t=new showtimef6N(this,c2,2);
	th=new Thread(t);
	th.start();
...
public static void checkscore(f6N bgf6N)
{int i;
bgf6N.c3.setText(""+(bgf6N.i*100)+"Points");
 bgf6N.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf6N.c3.setForeground(Color.black);

i=bgf6N.i*100;
bgf6N.k=i;
}
public static void check(f6N bgf6N)
{
int i,j,a;
if(bgf6N.i==15)
{
...
if(bgf6N.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf6N.c3.setText(""+(j+bgf6N.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf6N.h1.setVisible(false);}


if(bgf6N.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf6N.h2.setVisible(false);}


if(bgf6N.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf6N.h3.setVisible(false);}
bgf6N.k=bgf6N.k+a;

JOptionPane.showMessageDialog(null,"Total Score:"+bgf6N.k);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf6N.k);
		    fout.close();		
		}
		catch (IOException e)
		{
