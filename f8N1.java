...
class showhintf8N1 extends Thread
{
JLabel frm22;
public showhintf8N1(JLabel obj)
{
frm22=obj;
}
...
for(int i=0;i<10;i++)
{
frm22.setVisible(!frm22.isVisible());
Thread.sleep(220);
}
...
//-----------------------------------------------
class showtimef8N1 implements Runnable
{
f8N1 frm22;
int time;
JLabel lb24;
public showtimef8N1(f8N1 obj,JLabel object,int tm)
{
frm22=obj;
time=tm;
lb24=object;
...
{for(int j=60;j>=0;j--)
{lb24.setText(""+i+":"+j+"");
 lb24.setFont(new Font("Algerian", Font.BOLD,30));
...
class f8N1 extends JFrame implements MouseListener
{
...
panel.add(h1); h1.addMouseListener(this);
   ...
   c1.setBounds(1200, 660, size.width+120, size.height+80);
          c2.setBounds(250, 0, size.width+8, size.height+22);
          c3.setBounds(835, 6, size.width+80, size.height+22);
  h1.setBounds(10, 605, 100,100);
	 h2.setBounds(30, 605, 100,100);	
          h3.setBounds(50, 605, 100,100);

          label.setBounds(950, 213, size.width+80, size.height+80);
	  label1.setBounds(1009, 225, size.width+80, size.height+80);	
          label2.setBounds(410, 600, size.width+80, size.height+80);
	  label3.setBounds(829, 422, size.width+80, size.height+80);
	  label4.setBounds(650, 472, size.width+80, size.height+80);
	  label5.setBounds(273, 595, size.width+80, size.height+80);	
          label6.setBounds(946, 516, size.width+80, size.height+80);
	  label7.setBounds(980, 0, size.width+80, size.height+80);
	  label8.setBounds(51, 210, size.width+80, size.height+80);
	  label9.setBounds(5, 478, size.width+80, size.height+80);          
          label10.setBounds(1176, 375, size.width+80, size.height+80);
	  label11.setBounds(570, 436, size.width+80, size.height+80);
	  label12.setBounds(515, 560, size.width+80, size.height+80);
	  label13.setBounds(620, 546, size.width+80, size.height+80);
	  label14.setBounds(302, 475, size.width+80, size.height+80);
...
c3.setText(""+(i*100)+"Points");
 c3.setFont(new Font("algerian", Font.ITALIC,22));
      c3.setForeground(Color.black);
	pack();
showtimef8N1 t=new showtimef8N1(this,c2,2);
	 th=new Thread(t);
	th.start();
...
public static void checkscore(f8N1 bgf8N1)
{int i;
bgf8N1.c3.setText(""+(bgf8N1.i*100)+"Points");
 bgf8N1.c3.setFont(new Font("algerian", Font.ITALIC,22));
      bgf8N1.c3.setForeground(Color.black);
i=bgf8N1.i*100;
bgf8N1.k=i;
}
public static void check(f8N1 bgf8N1)
{
int i,j,a;
if(bgf8N1.i==15)
{
...
if(bgf8N1.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf8N1.c3.setText(""+(j+bgf8N1.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf8N1.h1.setVisible(false);}


if(bgf8N1.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf8N1.h2.setVisible(false);}


if(bgf8N1.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf8N1.h3.setVisible(false);}
bgf8N1.k=bgf8N1.k+a;

JOptionPane.showMessageDialog(null,"Total Score:"+bgf8N1.k);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf8N1.k);
		    fout.close();		
		}
		catch (IOException e)
		{
