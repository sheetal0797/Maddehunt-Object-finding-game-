...
import java.io.*;
class showhintf12N1 extends Thread
{
JLabel frm34;
public showhintf12N1(JLabel obj)
{
frm34=obj;
}
public void run()
...
for(int i=0;i<10;i++)
{
frm34.setVisible(!frm34.isVisible());
Thread.sleep(200);
}
frm34.setVisible(true);
}
catch(Exception ex)
{
...
//-----------------------------------------------
class showtimef12N1 implements Runnable
{
f12N1 frm34;
int time;
JLabel lb36;
public showtimef12N1(f12N1 obj,JLabel object,int tm)
{
frm34=obj;
time=tm;
lb36=object;
...
{for(int j=60;j>=0;j--)
{lb36.setText(""+i+":"+j+"");
 lb36.setFont(new Font("Algerian", Font.BOLD,30));
...
class f12N1 extends JFrame implements MouseListener
{
...
showtimef12N1 t=new showtimef12N1(this,c2,2);
	th=new Thread(t);
	th.start();
}
...
public static void checkscore(f12N1 bgf12N1)
{int i;
bgf12N1.c3.setText(""+(bgf12N1.i*100)+"Points");
 bgf12N1.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf12N1.c3.setForeground(Color.black);

i=bgf12N1.i*100;
bgf12N1.k=i;
}
public static void check(f12N1 bgf12N1)
{
int i,j,a;
if(bgf12N1.i==15)
{
...
if(bgf12N1.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf12N1.c3.setText(""+(j+bgf12N1.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf12N1.h1.setVisible(false);}


if(bgf12N1.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf12N1.h2.setVisible(false);}


if(bgf12N1.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf12N1.h3.setVisible(false);}
bgf12N1.k=bgf12N1.k+a;

JOptionPane.showMessageDialog(null,"Total Score:"+bgf12N1.k);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf12N1.k);
		    fout.close();		
		}
		catch (IOException e)
		{
