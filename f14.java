...
import java.io.*;
class showhintf14 extends Thread
{
JLabel frm38;
public showhintf14(JLabel obj)
{
frm38=obj;
}
...
for(int i=0;i<10;i++)
{
frm38.setVisible(!frm38.isVisible());
Thread.sleep(200);
}
frm38.setVisible(true);
}
catch(Exception ex)
{
...
//-----------------------------------------------
class showtimef14 implements Runnable
{
f14 frm38;
int time;
JLabel lb40;
public showtimef14(f14 obj,JLabel object,int tm)
{
frm38=obj;
time=tm;
lb40=object;
...
{for(int j=60;j>=0;j--)
{lb40.setText(""+i+":"+j+"");
 lb40.setFont(new Font("Algerian", Font.BOLD,30));
...
class f14 extends JFrame implements MouseListener
{
...
panel.add(c3);
   ...
   c1.setBounds(1170, 650, size.width+150, size.height+80);
          c2.setBounds(352, 5, size.width+100, size.height+20);
  ...
  h1.setBounds(10, 620, 100,100);
	 h2.setBounds(30, 620, 100,100);	
          ...
          label.setBounds(340, 90, size.width+80, size.height+80);
...
showtimef14 t=new showtimef14(this,c2,2);
	 th=new Thread(t);
	th.start();
}
...
public static void checkscore(f14 bgf14)
{int i,k25;
k25=bgf14.k25;
bgf14.c3.setText(""+(k25+(bgf14.i*100))+"Points");
 bgf14.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf14.c3.setForeground(Color.black);

bgf14.k26=k25+(bgf14.i*100);

}
public static void check(f14 bgf14)
{
int i,j,a;
if(bgf14.i==15)
{
...
if(bgf14.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf14.c3.setText(""+(j+bgf14.k26+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf14.h1.setVisible(false);}

if(bgf14.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf14.h2.setVisible(false);}


if(bgf14.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf14.h3.setVisible(false);}
bgf14.k26=bgf14.k26+a;
JOptionPane.showMessageDialog(null,"Total Score:"+bgf14.k26);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf14.k26);
		    fout.close();		
		}
		catch (IOException e)
		{
