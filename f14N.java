...
import java.io.*;
class showhintf14N extends Thread
{
JLabel frm39;
public showhintf14N(JLabel obj)
{
frm39=obj;
}
...
for(int i=0;i<10;i++)
{
frm39.setVisible(!frm39.isVisible());
Thread.sleep(200);
}
frm39.setVisible(true);
}
catch(Exception ex)
{
...
//-----------------------------------------------
class showtimef14N implements Runnable
{
f14N frm39;
int time;
JLabel lb41;
public showtimef14N(f14N obj,JLabel object,int tm)
{
frm39=obj;
time=tm;
lb41=object;
...
{for(int j=60;j>=0;j--)
{lb41.setText(""+i+":"+j+"");
 lb41.setFont(new Font("Algerian", Font.BOLD,30));
...
class f14N extends JFrame implements MouseListener
{
...
panel.add(c3);
  ...
  h1.setBounds(10, 620, 100,100);
	 h2.setBounds(30, 620, 100,100);	
          ...
          label.setBounds(545, 50, size.width+80, size.height+80);
	  label1.setBounds(720, 80, size.width+80, size.height+80);	
          label2.setBounds(20, 480, size.width+80, size.height+80);
	  label3.setBounds(170, 346, size.width+80, size.height+80);
	  label4.setBounds(1100, 650, size.width+80, size.height+80);
	  label5.setBounds(260, 460, size.width+80, size.height+80);	
          label6.setBounds(245, 310, size.width+80, size.height+80);
	  label7.setBounds(310, 470, size.width+80, size.height+80);
	  label8.setBounds(1180, 290, size.width+80, size.height+80);
	  label9.setBounds(1285, 200, size.width+80, size.height+80);          
          label10.setBounds(895, 350, size.width+80, size.height+80);
	  label11.setBounds(675, 280, size.width+80, size.height+80);
	  label12.setBounds(550, 245, size.width+80, size.height+80);
	  label13.setBounds(460, 300, size.width+80, size.height+80);
	  label14.setBounds(940, 180, size.width+80, size.height+80);
...
showtimef14N t=new showtimef14N(this,c2,2);
	 th=new Thread(t);
	th.start();
}
...
public static void checkscore(f14N bgf14N)
{int i;
bgf14N.c3.setText(""+(bgf14N.i*100)+"Points");
 bgf14N.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf14N.c3.setForeground(Color.black);

i=bgf14N.i*100;
bgf14N.k=i;
}
public static void check(f14N bgf14N)
{
int i,j,a;
if(bgf14N.i==15)
{
...
if(bgf14N.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf14N.c3.setText(""+(j+bgf14N.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf14N.h1.setVisible(false);}


if(bgf14N.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf14N.h2.setVisible(false);}


if(bgf14N.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf14N.h3.setVisible(false);}
bgf14N.k=bgf14N.k+a;
JOptionPane.showMessageDialog(null,"Total Score:"+bgf14N.k);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf14N.k);
		    fout.close();		
		}
		catch (IOException e)
		{
