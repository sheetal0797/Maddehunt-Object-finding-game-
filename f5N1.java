...
class showhintf5N1 extends Thread
{
JLabel frm13;
public showhintf5N1(JLabel obj)
{
frm13=obj;
}
...
for(int i=0;i<10;i++)
{
frm13.setVisible(!frm13.isVisible());
Thread.sleep(200);
}
...
//-----------------------------------------------
class showtimef5N1 implements Runnable
{
f5N1 frm13;
int time;
JLabel lb15;
public showtimef5N1(f5N1 obj,JLabel object,int tm)
{
frm13=obj;
time=tm;
lb15=object;
...
{
lb15.setText(""+i+"");
 lb15.setFont(new Font("Algerian", Font.BOLD,30));
...
class f5N1 extends JFrame implements MouseListener
{
...
c1.setIcon(new ImageIcon("obj/c6.png"));
	...
	label2.setIcon(new ImageIcon("obj/chirag.png"));
	label3.setIcon(new ImageIcon("obj/shave kit1.png"));
        label4.setIcon(new ImageIcon("obj/voilin.png"));
	...
	label12.setIcon(new ImageIcon("obj/knob.png"));
	label13.setIcon(new ImageIcon("obj/Sponge.png"));
	label14.setIcon(new ImageIcon("obj/leek.png"));
...
panel.add(h1); h1.addMouseListener(this);
   ...
   c1.setBounds(1200, 670, size.width+150, size.height+40);
          c2.setBounds(485, 0, size.width+80, size.height+20);
          c3.setBounds(818, 3, size.width+80, size.height+20);
  h1.setBounds(10, 610, 100,100);
	 h2.setBounds(30, 610, 100,100);	
          h3.setBounds(50, 610, 100,100);
                
          
          label.setBounds(993, 20, size.width+80, size.height+80);
	  label1.setBounds(636, 536, size.width+80, size.height+80);	
          label2.setBounds(1185, 490, size.width+80, size.height+80);
	  label3.setBounds(845, 404, size.width+80, size.height+80);
	  label4.setBounds(0, 172, size.width+80, size.height+80);
	  label5.setBounds(45, 55, size.width+80, size.height+80);	
          label6.setBounds(1165, 157, size.width+80, size.height+80);
	  label7.setBounds(995, 375, size.width+80, size.height+80);
	  label8.setBounds(1185, 290, size.width+80, size.height+80);
	  label9.setBounds(815, 290, size.width+80, size.height+80);          
          label10.setBounds(225, 390, size.width+80, size.height+80);
	  label11.setBounds(1085, 74, size.width+80, size.height+80);
	  label12.setBounds(1265, 402, size.width+80, size.height+80);
	  label13.setBounds(724, 358, size.width+80, size.height+80);
	  label14.setBounds(90, 265, size.width+80, size.height+80);
...
c3.setText(""+(i*100)+"Points");
 c3.setFont(new Font("algerian", Font.ITALIC,19));
	...
	pack();
showtimef5N1 t=new showtimef5N1(this,c2,2);
	th=new Thread(t);
	th.start();
...
public static void checkscore(f5N1 bgf5N1)
{int i;
bgf5N1.c3.setText(""+(bgf5N1.i*100)+"Points");
 bgf5N1.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf5N1.c3.setForeground(Color.black);

i=bgf5N1.i*100;
bgf5N1.k=i;
}
public static void check(f5N1 bgf5N1)
{int i,j,a;
if(bgf5N1.i==15)
{//JOptionPane.showMessageDialog(null,"Congratulations!!! You Have Cleared Stage Successfully.");
a=0;

if(bgf5N1.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf5N1.c3.setText(""+(j+bgf5N1.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf5N1.h1.setVisible(false);}


if(bgf5N1.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf5N1.h2.setVisible(false);}


if(bgf5N1.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf5N1.h3.setVisible(false);}
bgf5N1.k=bgf5N1.k+a;

JOptionPane.showMessageDialog(null,"Total Score:"+bgf5N1.k);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf5N1.k);
		    fout.close();		
		}
		catch (IOException e)
		{
