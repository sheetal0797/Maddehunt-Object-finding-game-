...
import java.io.*;
class showhintf13N extends Thread
{
JLabel frm36;
public showhintf13N(JLabel obj)
{
frm36=obj;
}
...
for(int i=0;i<10;i++)
{
frm36.setVisible(!frm36.isVisible());
Thread.sleep(200);
}
frm36.setVisible(true);
}
catch(Exception ex)
{
...
//-----------------------------------------------
class showtimef13N implements Runnable
{
f13N frm36;
int time;
JLabel lb38;
public showtimef13N(f13N obj,JLabel object,int tm)
{
frm36=obj;
time=tm;
lb38=object;
...
{for(int j=60;j>=0;j--)
{lb38.setText(""+i+":"+j+"");
 lb38.setFont(new Font("Algerian", Font.BOLD,30));
...
class f13N extends JFrame implements MouseListener
{
...
panel.add(c3);
  ...
  h1.setBounds(10, 620, 100,100);
	 h2.setBounds(30, 620, 100,100);	
          ...
          label.setBounds(90, 462, size.width+80, size.height+80);
	  label1.setBounds(575, 113, size.width+80, size.height+80);	
          label2.setBounds(455, 300, size.width+80, size.height+80);
	  label3.setBounds(706, 520, size.width+80, size.height+80);
	  label4.setBounds(240, 304, size.width+80, size.height+80);
	  label5.setBounds(580, 525, size.width+80, size.height+80);	
          label6.setBounds(780, 270, size.width+80, size.height+80);
	  label7.setBounds(420, 220, size.width+80, size.height+80);
	  label8.setBounds(100, 400, size.width+80, size.height+80);
	  label9.setBounds(650, 320, size.width+80, size.height+80);          
          label10.setBounds(850, 70, size.width+80, size.height+80);
	  label11.setBounds(1090, 380, size.width+80, size.height+80);
	  label12.setBounds(560, 445, size.width+80, size.height+80);
	  label13.setBounds(1100, 170, size.width+80, size.height+80);
	  label14.setBounds(1180, 180, size.width+80, size.height+80);
...
showtimef13N t=new showtimef13N(this,c2,2);
	 th=new Thread(t);
	th.start();
}
...
public static void checkscore(f13N bgf13N)
{int i;
bgf13N.c3.setText(""+(bgf13N.i*100)+"Points");
 bgf13N.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf13N.c3.setForeground(Color.black);

i=bgf13N.i*100;
bgf13N.k=i;
}
public static void check(f13N bgf13N)
{
int i,j,a;
if(bgf13N.i==15)
{
...
if(bgf13N.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf13N.c3.setText(""+(j+bgf13N.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf13N.h1.setVisible(false);}


if(bgf13N.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf13N.h2.setVisible(false);}


if(bgf13N.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf13N.h3.setVisible(false);}
bgf13N.k=bgf13N.k+a;
JOptionPane.showMessageDialog(null,"Total Score:"+bgf13N.k);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf13N.k);
		    fout.close();		
		}
		catch (IOException e)
		{
