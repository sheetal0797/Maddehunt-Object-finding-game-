...
import java.io.*;
class showhintf11N extends Thread
{
JLabel frm30;
public showhintf11N(JLabel obj)
{
frm30=obj;
}
public void run()
...
for(int i=0;i<10;i++)
{
frm30.setVisible(!frm30.isVisible());
Thread.sleep(200);
}
frm30.setVisible(true);
}
catch(Exception ex)
{
...
//-----------------------------------------------
class showtimef11N implements Runnable
{
f11N frm30;
int time;
JLabel lb28;
public showtimef11N(f11N obj,JLabel object,int tm)
{
frm30=obj;
time=tm;
lb28=object;
...
class f11N extends JFrame implements MouseListener
{
...
showtimef11N t=new showtimef11N(this,c2,2);
	th=new Thread(t);
	th.start();
}
...
public static void checkscore(f11N bgf11N)
{int i,k17;
k17=bgf11N.k17;
bgf11N.c3.setText(""+(k17+(bgf11N.i*100))+"Points");
 bgf11N.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf11N.c3.setForeground(Color.black);
bgf11N.k18=k17+(bgf11N.i*100);

}
public static void check(f11N bgf11N)
{
...
if(bgf11N.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf11N.c3.setText(""+(j+bgf11N.k18+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf11N.h1.setVisible(false);}


if(bgf11N.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf11N.h2.setVisible(false);}


if(bgf11N.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf11N.h3.setVisible(false);}
bgf11N.k18=bgf11N.k18+a;
JOptionPane.showMessageDialog(null,"Total Score:"+bgf11N.k18);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf11N.k18);
		    fout.close();		
		}
		catch (IOException e)
		{
