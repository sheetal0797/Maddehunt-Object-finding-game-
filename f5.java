...
import java.io.*;
class showhintf5 extends Thread
{
JLabel frm11;
public showhintf5(JLabel obj)
{
frm11=obj;
}
...
for(int i=0;i<10;i++)
{
frm11.setVisible(!frm11.isVisible());
Thread.sleep(200);
}
...
//-----------------------------------------------
class showtimef5 implements Runnable
{
f5 frm11;
int time;
JLabel lb13;
public showtimef5(f5 obj,JLabel object,int tm)
{
frm11=obj;
time=tm;
lb13=object;
...
{for(int j=60;j>=0;j--)
{lb13.setText(""+i+":"+j+"");
 lb13.setFont(new Font("Algerian", Font.BOLD,30));
...
class f5 extends JFrame implements MouseListener
{
...
c1.setIcon(new ImageIcon("obj/c6.png"));
	...
	label2.setIcon(new ImageIcon("obj/chiraag.png"));
	...
	label13.setIcon(new ImageIcon("obj/sponge1.png"));
...
panel.add(h1); h1.addMouseListener(this);
	...
	panel.add(h3); h3.addMouseListener(this);
	   Dimension size = label.getPreferredSize();
          ...
          c3.setBounds(810, 0, size.width+80, size.height+20);
 
         h1.setBounds(10, 610, 100,100);
	 h2.setBounds(30, 610, 100,100);	
          h3.setBounds(50, 610, 100,100);
            label.setBounds(55, 55, size.width+80, size.height+80);
	  label1.setBounds(1120, 125, size.width+80, size.height+80);	
          label2.setBounds(220, 325, size.width+80, size.height+80);
	  label3.setBounds(1250, 525, size.width+80, size.height+80);
	  label4.setBounds(105, 315, size.width+80, size.height+80);
	  label5.setBounds(1130, 90, size.width+80, size.height+80);	
          label6.setBounds(465, 155, size.width+80, size.height+80);
	  label7.setBounds(495, 310, size.width+80, size.height+80);
	  label8.setBounds(1183, 290, size.width+80, size.height+80);
	  label9.setBounds(815, 290, size.width+80, size.height+80);          
          label10.setBounds(980, 430, size.width+80, size.height+80);
	  label11.setBounds(1155, 0, size.width+80, size.height+80);
	  label12.setBounds(0, 187, size.width+80, size.height+80);
	  label13.setBounds(770, 377, size.width+80, size.height+80);
	  label14.setBounds(89, 263, size.width+80, size.height+80);
...
c3.setText(""+(i*100)+"Points");
 c3.setFont(new Font("algerian", Font.ITALIC,19));
	...
	pack();
showtimef5 t=new showtimef5(this,c2,2);
	th=new Thread(t);
	th.start();
...
public static void checkscore(f5 bgf5)
{int i,k7;
k7=bgf5.k7;
bgf5.c3.setText(""+(k7+(bgf5.i*100))+"Points");
 bgf5.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf5.c3.setForeground(Color.black);

bgf5.k8=k7+(bgf5.i*100);

}
public static void check(f5 bgf5)
{
int i,j,a;
if(bgf5.i==15)
{
...
if(bgf5.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf5.c3.setText(""+(j+bgf5.k8+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf5.h1.setVisible(false);}


if(bgf5.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf5.h2.setVisible(false);}


if(bgf5.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf5.h3.setVisible(false);}
bgf5.k8=bgf5.k8+a;

JOptionPane.showMessageDialog(null,"Total Score:"+bgf5.k8);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf5.k8);
		    fout.close();		
		}
		catch (IOException e)
		{
