...
import java.io.*;
class showhintf4N1 extends Thread
{
JLabel frm10;
public showhintf4N1(JLabel obj)
{
frm10=obj;
}
...
for(int i=0;i<10;i++)
{
frm10.setVisible(!frm10.isVisible());
Thread.sleep(200);
}
...
//---------------------------------------
class showtimef4N1 implements Runnable
{
f4N1 frm10;
int time;
JLabel lb12;
public showtimef4N1(f4N1 obj,JLabel object,int tm)
{
frm10=obj;
time=tm;
lb12=object;
...
{for(int j=60;j>=0;j--)
{lb12.setText(""+i+":"+j+"");
 lb12.setFont(new Font("Algerian", Font.BOLD,30));
...
class f4N1 extends JFrame implements MouseListener
{
...
panel.add(h1); h1.addMouseListener(this);
  ...
  h1.setBounds(10, 620, 100,100);
	 h2.setBounds(30, 620, 100,100);	
          ...
          label.setBounds(90, 228, size.width+50, size.height+50);
	  label1.setBounds(871, 268, size.width+50, size.height+50);	
          label2.setBounds(490, 570, size.width+50, size.height+50);
	  label3.setBounds(930, 330, size.width+80, size.height+80);
	  label4.setBounds(1110, 0, size.width+80, size.height+80);
	  label5.setBounds(1210, 390, size.width+80, size.height+80);	
          label6.setBounds(580, 600, size.width+80, size.height+80);
	  label7.setBounds(570, 260, size.width+80, size.height+80);
	  label8.setBounds(10,590, size.width, size.height);
	  label9.setBounds(413, 120, size.width+80, size.height+80);          
          label10.setBounds(420, 415, size.width+80, size.height+80);
	  label11.setBounds(1190, 325, size.width+80, size.height+80);
	  label12.setBounds(590, 60, size.width+80, size.height);
	  label13.setBounds(675, 576, size.width+80, size.height+80);
	  label14.setBounds(190, 582, size.width+80, size.height+80);
...
c3.setText(""+(i*100)+"Points");
 c3.setFont(new Font("algerian", Font.ITALIC,19));
	...
	pack();
showtimef4N1 t=new showtimef4N1(this,c2,2);
	th=new Thread(t);
	th.start();
...
public static void checkscore(f4N1 bgf4N1)
{int i;
bgf4N1.c3.setText(""+(bgf4N1.i*100)+"Points");
 bgf4N1.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf4N1.c3.setForeground(Color.black);

i=bgf4N1.i*100;
bgf4N1.k=i;
}
public static void check(f4N1 bgf4N1)
{int i,j,a;
if(bgf4N1.i==15)
{//JOptionPane.showMessageDialog(null,"Congratulations!!! You Have Cleared Stage Successfully.");
a=0;

if(bgf4N1.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf4N1.c3.setText(""+(j+bgf4N1.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf4N1.h1.setVisible(false);}


if(bgf4N1.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf4N1.h2.setVisible(false);}


if(bgf4N1.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf4N1.h3.setVisible(false);}
bgf4N1.k=bgf4N1.k+a;
JOptionPane.showMessageDialog(null,"Total Score:"+bgf4N1.k);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf4N1.k);
		    fout.close();		
		}
		catch (IOException e)
		{
