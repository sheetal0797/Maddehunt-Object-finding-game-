...
class showhintf7N1 extends Thread
{
JLabel frm19;
public showhintf7N1(JLabel obj)
{
frm19=obj;
}
...
for(int i=0;i<10;i++)
{
frm19.setVisible(!frm19.isVisible());
Thread.sleep(200);
}
...
//-----------------------------------------------
class showtimef7N1 implements Runnable
{
f7N1 frm19;
int time;
JLabel lb21;
public showtimef7N1(f7N1 obj,JLabel object,int tm)
{
frm19=obj;
time=tm;
lb21=object;
...
{for(int j=60;j>=0;j--)
{lb21.setText(""+i+":"+j+"");
 lb21.setFont(new Font("Algerian", Font.BOLD,30));
...
class f7N1 extends JFrame implements MouseListener
{
...
c3.setText(""+(i*100)+"Points");
 c3.setFont(new Font("algerian", Font.ITALIC,19));
	...
	pack();
showtimef7N1 t=new showtimef7N1(this,c2,2);
	th=new Thread(t);
	th.start();
...
public static void checkscore(f7N1 bgf7N1)
{int i;
bgf7N1.c3.setText(""+(bgf7N1.i*100)+"Points");
 bgf7N1.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf7N1.c3.setForeground(Color.black);
i=bgf7N1.i*100;
bgf7N1.k=i;
}
public static void check(f7N1 bgf7N1)
{
int i,j,a;
if(bgf7N1.i==15)
{
...
if(bgf7N1.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf7N1.c3.setText(""+(j+bgf7N1.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf7N1.h1.setVisible(false);}


if(bgf7N1.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf7N1.h2.setVisible(false);}


if(bgf7N1.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf7N1.h3.setVisible(false);}
bgf7N1.k=bgf7N1.k+a;

JOptionPane.showMessageDialog(null,"Total Score:"+bgf7N1.k);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf7N1.k);
		    fout.close();		
		}
		catch (IOException e)
		{
