...
import java.io.*;
class showhintf15N1 extends Thread
{
JLabel frm43;
public showhintf15N1(JLabel obj)
{
frm43=obj;
}
...
for(int i=0;i<10;i++)
{
frm43.setVisible(!frm43.isVisible());
Thread.sleep(200);
}
frm43.setVisible(true);
}
catch(Exception ex)
{
...
//-----------------------------------------------
class showtimef15N1 implements Runnable
{
f15N1 frm43;
int time;
JLabel lb45;
public showtimef15N1(f15N1 obj,JLabel object,int tm)
{
frm43=obj;
time=tm;
lb45=object;
...
{for(int j=60;j>=0;j--)
{lb45.setText(""+i+":"+j+"");
 lb45.setFont(new Font("Algerian", Font.BOLD,30));
...
class f15N1 extends JFrame implements MouseListener
{
...
panel.add(c3);
   ...
   c1.setBounds(1170, 665, size.width+60, size.height+20);
          c2.setBounds(352, 0, size.width+20, size.height+10);
  ...
  h1.setBounds(10, 620, 100,100);
	 h2.setBounds(30, 620, 100,100);	
	  ...
	  label1.setBounds(520, 380, size.width, size.height);	
          label2.setBounds(145, 530, size.width, size.height);
	  label3.setBounds(675, 365, size.width, size.height);
	  label4.setBounds(0, 280, size.width, size.height);
	  label5.setBounds(800, 550, size.width, size.height);	
          label6.setBounds(622, 150, size.width, size.height);
	  label7.setBounds(200, 300, size.width, size.height);
	  label8.setBounds(910, 383, size.width, size.height);
	  label9.setBounds(1270, 326, size.width, size.height);          
          label10.setBounds(340, 380, size.width, size.height);
...
showtimef15N1 t=new showtimef15N1(this,c2,2);
	th=new Thread(t);
	th.start();
}
...
public static void checkscore(f15N1 bgf15N1)
{int i;
bgf15N1.c3.setText(""+(bgf15N1.i*100)+"Points");
 bgf15N1.c3.setFont(new Font("algerian", Font.ITALIC,19));
      bgf15N1.c3.setForeground(Color.black);

i=bgf15N1.i*100;

}
public static void check(f15N1 bgf15N1)
{
int i,j,a;
if(bgf15N1.i==15)
{
...
if(bgf15N1.h1.isVisible()==true)
{
JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<=100;j++)
{
bgf15N1.c3.setText(""+(j+bgf15N1.k+a)+"Points");
Thread.sleep(5);}
}
catch(Exception ex){JOptionPane.showMessageDialog(null,ex.getMessage());}
a=a+100;
bgf15N1.h1.setVisible(false);}


if(bgf15N1.h2.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
...
a=a+100;
bgf15N1.h2.setVisible(false);}


if(bgf15N1.h3.isVisible()==true)
{JOptionPane.showMessageDialog(null,"Congratulations!!! hint bonus:100 points");
try
{for(j=0;j<100;j++)
{
...
a=a+100;
bgf15N1.h3.setVisible(false);}
bgf15N1.k=bgf15N1.k+a;
JOptionPane.showMessageDialog(null,"Total Score:"+bgf15N1.k);
String r1=null;  
FileInputStream fin;
...
FileOutputStream fout;		
		...
		try
		{
		    ...
		    new PrintStream(fout).print(bgf15N1.k);
		    fout.close();		
		}
		catch (IOException e)
		{
